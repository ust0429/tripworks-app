// src/components/DirectRequestModal.tsx の先頭を修正
import React, { useState } from 'react';
import { Gift, ChevronDown } from 'lucide-react';
import { AttenderType } from '../types'; // パスを変更
...
const DirectRequestModal: React.FC<DirectRequestModalProps> = ({ attender, onClose }) => {
