  ...
  useEffect(() => {
    const fetchAttenderProfile = async () => {
      ...
      try {
        ...
        // APIからプロフィールを取得
        const response = await apiClient.get<AttenderProfile>(ENDPOINTS.ATTENDER.DETAIL(id as string));
        
        logApiResponse('GET', ENDPOINTS.ATTENDER.DETAIL(id as string), response);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold">
            {loading ? 'アテンダー情報読み込み中...' : profile?.name || 'アテンダープロフィール'}
          </h1>
